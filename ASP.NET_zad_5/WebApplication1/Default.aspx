...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/DodawaniePracownika.aspx">Dodaj</asp:HyperLink>
            <br />
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/UsuwaniePracownika.aspx">Usuń</asp:HyperLink>
        </div>
    </form>
</body>
</html>
